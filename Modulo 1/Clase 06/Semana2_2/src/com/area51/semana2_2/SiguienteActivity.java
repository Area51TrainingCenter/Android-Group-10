...
public class SiguienteActivity extends Activity {
	...
	protected void onResume() {
		...
		list.add(new Item(1, "", "", R.drawable.sample_0));
		list.add(new Item(2, "", "", R.drawable.sample_1));
		list.add(new Item(3, "", "", R.drawable.sample_2));
		list.add(new Item(4, "", "", R.drawable.sample_3));
		list.add(new Item(5, "", "", R.drawable.sample_4));
		list.add(new Item(6, "", "", R.drawable.sample_5));
		list.add(new Item(7, "", "", R.drawable.sample_6));
		list.add(new Item(8, "", "", R.drawable.sample_7));
		list.add(new Item(9, "", "", R.drawable.sample_8));
